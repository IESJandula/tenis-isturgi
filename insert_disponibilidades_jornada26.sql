-- Insert disponibilidades for Jornada 26 (current Jornada 1) with overlapping slots
INSERT INTO disponibilidades (jugador_id, jornada_id, slots, created_at, updated_at) 
SELECT j.id, 26, '{"viernes":{"16:00":true},"sabado":{},"domingo":{}}', NOW(), NOW() 
...
INSERT INTO disponibilidades (jugador_id, jornada_id, slots, created_at, updated_at) 
SELECT j.id, 26, '{"viernes":{},"sabado":{"09:00":true},"domingo":{}}', NOW(), NOW() 
...
INSERT INTO disponibilidades (jugador_id, jornada_id, slots, created_at, updated_at) 
SELECT j.id, 26, '{"viernes":{"11:00":true},"sabado":{},"domingo":{}}', NOW(), NOW() 
